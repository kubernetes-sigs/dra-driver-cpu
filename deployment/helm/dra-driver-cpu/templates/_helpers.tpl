...
{{- /* The registrar socket under this root has to fit sun_path: 108 bytes minus
       ...
       and again in the driver, which is
       the one that has to be right -- deliberately not in the values schema,
       since maxLength counts characters and sees the value before cleaning. */ -}}
