...
// NOTE: This file is a copy of https://github.com/kubernetes/kubernetes/blob/master/pkg/kubelet/cm/cpumanager/cpu_assignment_test.go with minor modifications
...
// TODO(pravk03): Rename this struct and move this outside of test file if we decide to support more packing options from the DRA driver.
