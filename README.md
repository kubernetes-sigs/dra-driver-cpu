...
- [Custom Opaque CPUSet Allocation Overrides](docs/user/opaque-cpuset-overrides.md) - implement explicit core assignment for `groupBy: machine` mode; recommended upgrade path for users of `individual` mode.
